    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/shankscs2/cs2-maps-wiki',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Discord',
                href: 'https://discord.gg/JbmmWQUcuV',
              },
              {
                label: 'Twitter',
                href: 'https://twitter.com/shankscs2',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} shankscs2. Built with Docusaurus.`,
      },
      prism: {
